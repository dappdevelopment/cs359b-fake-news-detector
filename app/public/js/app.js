     ...
     "https://dapps.stanford.edu/fakenewsdetector/articles",
         ...
         function(data) {
          ...
          data.forEach(function(article) {
            ...
            <article> \
            <header> \
            <span class=\"date\">Vote Deadline: "+article.deadline+"</span> \
            ...
            <label for=\"some-errors\">1-3 errors</label>\
            <input type=\"radio\" id=\"many-errors\" name=\"demo-priority\" checked>\
            <label for=\"many-errors\">FAKE news!</label>\
            <ul class=\"actions\"> \
            <li><a href=\""+article.url+"\"class=\"button\">Vote</a></li>\
            </ul>\
            </article>";
            $('#feed').append(article);
          });
